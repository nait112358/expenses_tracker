...
let balanceTotal = account[0];
let expensesTotal = account[1];
let initialBalance = account[2];
...
const createRow = (kind, amount, id) => {
  ...
  let articles = `<article class="expenses-table-kind">${kind}</article>
    ...
    <article class="expenses-table-bin"><a href="#" class="text-decoration-none" id="a${id}" onCLick="binBtn(this.id);">
